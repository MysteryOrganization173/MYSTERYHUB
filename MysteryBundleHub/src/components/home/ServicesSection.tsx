...
const HOME_SERVICES: HomeService[] = [
  {
    ...
    icon:        Wifi,
    name:        "Data Bundles",
    description: "Buy MTN, AirtelTigo, and Telecel bundles at the best prices. Express and budget options available.",
    href:        "/buy",
    color:       "brand",
  },
  {
  ...
  return (
    <Section size="lg">
      <SectionHeader
        ...
        description="From data bundles to examination results — every digital service you need, covered."
      />
