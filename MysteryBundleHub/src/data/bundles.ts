/**
 * Mock Bundle Data — Mystery Hub
 *
 * This file is the SINGLE source of truth for bundle and network data
 ...
 *
 * Pricing as of Mystery Hub launch:
...
export const NETWORK_OPTIONS: NetworkOption[] = [
  ...
  },
  {
    ...
    shortName: "MTN",
    color: "#FFA500",
    description: "MTN data at wallet-friendly prices.",
    available: true,
  },
  {
    id: "airteltigo",
  ...
  },
  {
    ...
    shortName: "TC",
    color: "#CC0000",
    description: "Big bundles for power users.",
    available: true,
  },
];
...
export const DATA_BUNDLES: DataBundle[] = [
  ...
  // ── MTN Budget ─────────────────────────────────────────────────────────────
  {
    ...
    available: true,
    description: "Budget-friendly for casual use.",
  },
  {
    id: "mtn-budget-2gb",
    network: "mtn-budget",
    ...
    shieldProtection: false,
    available: true,
    description: "More data at a smarter price.",
    popular: true,
  },
  {
    id: "mtn-budget-3gb",
  ...
  },
  {
    ...
    shieldProtection: false,
    available: true,
    description: "Maximum data at minimum cost.",
    bestValue: true,
  },
