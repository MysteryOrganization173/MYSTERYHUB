...
export const SERVICES: readonly ServiceMeta[] = [
  {
    id:          "buy",
    name:        "Buy",
    description: "Browse digital and mobile services, including internet packages.",
    href:        "/buy",
    icon:        "ShoppingBag",
  },
  {
    id:          "marketplace",
    name:        "Marketplace",
    description: "Explore digital products, vouchers, and verified sellers.",
    href:        "/marketplace",
    icon:        "Store",
  },
  {
  ...
  },
  {
    ...
    description: "Check WAEC, BECE, and other national examination results.",
    href:        "/checker",
    icon:        "ScanLine",
  },
] as const;
...
export const BRAND_META = {
  ...
  description:
    "Mystery Hub is a digital services platform for connectivity, mobile services, and more.",
  primaryColor:    "#18C964",
...
export const PAGE_TITLES = {
  ...
  buy:         "Internet Packages | Mystery Hub",
